...
const metaMap: Record<string, { title: string; description: string }> = {
  "study-visa": {
    title: "Study Visa Consultants in Ahmedabad | Zeel Overseas",
  ...
  "work-visa": {
    title: "Work Visa Consultants in Ahmedabad | Zeel Overseas",
  ...
  "permanent-residency": {
    title: "PR Visa Consultants in Ahmedabad | Zeel Overseas",
  ...
  "tourist-visa": {
    title: "Tourist Visa Assistance in Ahmedabad | Zeel Overseas",
  ...
  "business-visa": {
    title: "Business Visa Consultants in Ahmedabad | Zeel Overseas",
